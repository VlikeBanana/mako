 ...
 */
unsigned int red_whites_val = 64;
unsigned int green_whites_val = 64;
unsigned int blue_whites_val = 64;

/*
 * Grays for RED, GREEN and BLUE
 */
unsigned int red_greys_val = 32;
unsigned int green_greys_val = 32;
