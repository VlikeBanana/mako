...
LDFLAGS_MODULE  =
ifdef CONFIG_CC_OPTIMIZE_O3
CFLAGS_KERNEL	= -O3 -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4 -ftree-vectorize -pipe
AFLAGS_KERNEL	= -O3 -mcpu=cortex-a15 -mtune=cortex-a15 -mfpu=neon-vfpv4 -ftree-vectorize -pipe
else
